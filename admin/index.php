            ...
            <div class="reg-form">
				...
				?> 
                    ...
                    <form style="display: inline-block;">
              		<?var url = getUrl();?><a href="panel.php"><input style=" margin-bottom: -5px; margin-left: -5px;" type='button' class="btn btn-success log-btn" name='test		' value='Users'>
  			...
  			<tr>
  				<?php
  					foreach ($row as $product) 
					{
					    ...
					    echo '<td><img width="200" src="../progects/uploads/' .$product['image']. '" /></td>';
